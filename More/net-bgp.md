...
- Позволяет автономным системам (AS) обмениваться информацией о доступных сетях и выбирать оптимальные пути для передачи трафика
...
2. **iBGP** (Internal BPG) - обмен маршрутами внутри одной AS.
