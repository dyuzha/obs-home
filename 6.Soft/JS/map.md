...
---
Аналог map, но:
1. Ключами могут быть только объекты, а не примитивными значениями.
2. автоматическое удаление не используемых объектов сборщиком муссора, когда эти объекты выступают в качестве ключей.
...
Такие ограничения из-за особенностей технической реализации.
Если объект удалиться сборщиком муссора, при недосягаемости, то не известно когда именно.
